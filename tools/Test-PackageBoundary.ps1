...
function Test-PackageBoundary {
    ...
    $ExpectedFiles = @(
        ...
        'skills/agentic-sdlc-audit/assets/improvement-guide-template.md'
        'skills/agentic-sdlc-audit/assets/report-template.md'
        'skills/agentic-sdlc-audit/assets/starter-guide-template.md'
        ...
        'skills/agentic-sdlc-audit/scripts/evidence-references.mjs'
        'skills/agentic-sdlc-audit/scripts/evidence-scoring.mjs'
        'skills/agentic-sdlc-audit/scripts/github-remote-adapter.mjs'
        'skills/agentic-sdlc-audit/scripts/guide-command.mjs'
        'skills/agentic-sdlc-audit/scripts/guide-renderer.mjs'
        'skills/agentic-sdlc-audit/scripts/local-collector.mjs'
        'skills/agentic-sdlc-audit/scripts/remediation-view.mjs'
        'skills/agentic-sdlc-audit/scripts/rendering-safety.mjs'
        'skills/agentic-sdlc-audit/scripts/report-renderer.mjs'
        'skills/agentic-sdlc-audit/scripts/scan.sh'
        'skills/agentic-sdlc-audit/scripts/source-registry.mjs'
        'plugin.json'
    )
